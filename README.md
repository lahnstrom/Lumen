...
4. Choose **Build learning kit**. It creates a concept map and flashcards from your conversation and sources. Building again extends the map and adds new cards, skipping exact duplicate questions. Existing concept descriptions, positions, card links, and cross-space connections are preserved. Matching concept labels reuse stable identities; use **Edit map** to change or remove existing content. Maps support 50 concepts and 250 connections; any rejected additions are reported in the reply.
...
The overview puts learning spaces with ready cards first, with title search, ready/unpractised filters, recent-review sorting, and a **Show more spaces** control. Paused and unavailable Anki cards are listed separately from available cards.
